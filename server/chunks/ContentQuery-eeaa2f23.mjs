...
import { u as useNuxtApp, b as useRuntimeConfig } from './app.config-f3ff7543.mjs';
import { c as createError } from './server.mjs';
import { hash } from 'ohash';
import { withLeadingSlash, joinURL, withoutTrailingSlash } from 'ufo';
import { c as createQuery, u as useCookie } from './query-0ced36ee.mjs';
import { w as withContentBase, a as addPrerenderPath, s as shouldUseClientDB } from './utils-f18771c5.mjs';
import 'hookable';
import 'unctx';
import 'h3';
import 'ofetch';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-1a01e85f.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=ContentQuery-eeaa2f23.mjs.map

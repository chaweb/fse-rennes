...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-2e98d623.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-6e633d66.mjs').then((r) => r.default || r));
...
//# sourceMappingURL=error-component-48baaf5b.mjs.map
